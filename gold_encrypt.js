...
const fs = require('fs');
fs.writeFileSync('gold_payload.json', JSON.stringify({
    intro: encryptGold(introMessage, password),
    letter: encryptGold(letterContent, password)
}, null, 2));

console.log("Written to gold_payload.json");
