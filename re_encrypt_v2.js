...
// UTF-8 Safe XOR Encryption
function xorCipherUTF8(text, pass) {
    ...
    // Convert to Base64 in Node.js
    return Buffer.from(result).toString('base64');
}

// Encrypt
const encryptedLetter = xorCipherUTF8(letterContent, password);
const encryptedMessage = xorCipherUTF8(message, password);

console.log("XOR_ENCRYPTED_LETTER_START");
console.log(encryptedLetter);
console.log("XOR_ENCRYPTED_LETTER_END");

console.log("XOR_ENCRYPTED_MESSAGE_START");
...
fs.writeFileSync('encrypted_payload_v2.json', JSON.stringify(payload, null, 2));
console.log("Encrypted payload written to encrypted_payload_v2.json");
